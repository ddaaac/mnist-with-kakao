...
attri_num = 784   #사용할 속성 수 입력 - 읽어올 수도 있는데 이렇게 직접 쓰면 좀 더 이해가 되지 않을까싶어서 직접 입력하도록 함.
class_num = 10   #사용할 분류 수 입력 - 마찬가지


train_data = []
label_data = []

read_file =pd.read_csv('./mnist_to_csv.csv')
#read_file = pd.read_csv('./StudentsPerformance.csv')
